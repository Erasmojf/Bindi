...
mixin _$EditAccountStore on _EditAccountStore, Store {
  ...
  bool get isFormValid =>
      (_$isFormValidComputed ??= Computed<bool>(() => super.isFormValid,
          ...
          .value;
  Computed<VoidCallback> _$savedPressedComputed;

  @override
  VoidCallback get savedPressed => (_$savedPressedComputed ??=
          Computed<VoidCallback>(() => super.savedPressed,
              name: '_EditAccountStore.savedPressed'))
      .value;
